const Blogs = () => {
    return (
        <>
        <div className="fade mt-60 text-center mb-20 p-5">
        <h1 className="text-5xl mb-10">Ergonomic & Modular Office Furniture for Modern Offices in Chennai</h1>
        <h2 className="text-3xl">Tailored Workstations, Ergonomic Chairs, and Executive Furniture</h2>
        </div>
