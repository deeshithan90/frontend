const OurStrenghts = () => {
  return (
    <div className="mb-10">
        <h1 className="text-4xl font-bold">Our Strenghts</h1>
        <div className='w-full mt-10 flex gap-40 mss'>
            <img
        ...
        <div className='mt-0 flexs gap-40 ml-o80 mss'>
            <ul className="grid grid-cols-1 gap-3 text-2xl">
               ...
               <li>Supply Chain & Vendor Mangement Expertise</li>
               <li>Installation & After Sales Support  Team</li>
            </ul>
            <img
             className='w-[250px] p-3 zoom-in shadowss'
             src='/ours/2.png'
        ...
        <div className='w-full flexs gap-40 mt-0 mss'>
            <img
             className='w-[250px] p-3 zoom-in shadowss'
             src='/ours/3.png'
            />
        ...
        <div className='mt-0  flexs gap-40 ml-o80 mss'>
          <ul className="grid grid-cols-1 gap-3 text-2xl">
               ...
               <li>Skilled Workforce Strength</li>
               <li>Inventory & Production Planning System</li>
         </ul>
           <img
             className='w-[250px] p-3 zoom-in shadowss'
             src='/ours/4.png'
       ...
       <div className="mt-0 mb-5 p-15 flex gap-40 mss">
            <img
             className='w-[250px] p-3 zoom-in shadowss'
             src='/ours/5.png'
            />
        ...
        <div className='mt-0 ml-080 flexs gap-40 mss'>   
          <ul className="grid grid-cols-1 gap-3 text-2xl">
               ...
               <li>One-Site Inspection & Maintenace</li>
               <li>Long-Term Partnership Approch</li>
         </ul>         
          <img
             className='w-[250px] p-3 zoom-in shadowss'
             src='/ours/6.png'
